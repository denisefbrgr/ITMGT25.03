...
def body_mass_index(weight, height):
    ...
    # Replace `pass` with your code.
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    weight_kg = weight / 2.205 # conversion of weight into kg

    feet = height[0]
    inches = height[1]

    feet_m = feet / 3.281 # convert feet into m
    inches_m = inches /  39.37 # convert inches into m

    height_m = feet_m + inches_m # height converted into m
